...
function Heading() {
  ...
  return (
    <div className="container header">
      <div className="row">
        <nav
          class="col-12 navbar navbar-expand-lg navbar-light bg-white"
          id="nav"
        >
          <a class="navbar-brand" href="/ecommerceWebsite/product">
            <img
              src="https://res.cloudinary.com/dx0cslxpx/image/upload/v1701536205/ecommerce/logo/logo_ak6xpi.jpg"
              alt="pic1"
              className="logo"
            />
          </a>
          ...
          <div class="collapse navbar-collapse text-dark" id="navbarNav">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item active">
                <Link class="nav-link" id="link" to="/">
                  Home <span class="sr-only">(current)</span>
                </Link>
              </li>
              <li class="nav-item">
                <Link class="nav-link" id="link" to="/product">
                  Product
                </Link>
              </li>
              <li class="nav-item">
                <Link class="nav-link" id="link" to="/cart">
                  Cart
                </Link>
              </li>
              {/*<li class="nav-item">
